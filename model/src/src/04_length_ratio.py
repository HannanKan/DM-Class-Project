...
test_x = df_feature.loc[test_index]
df_feature = []
...
print('Saving...')
print('train_part...')
train_part_x[col_new].to_csv(abs_path('train_part_x_length.csv',DATA_P_DIR),index=False)
print('test...')
test_x[col_new].to_csv(abs_path('test_x_length.csv',DATA_P_DIR),index=False)
print('Over')